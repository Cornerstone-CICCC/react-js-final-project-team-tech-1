  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        <Spline scene="https://prod.spline.design/HGkdkoNdUK3tYJGd/scene.splinecode" />
      </div>
        ...
        <Card className="w-full max-w-md bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl rounded-xl">
          <CardContent className="p-8">
            ...
            <div className="flex flex-col items-center mb-5">
              <p className="text-lg text-white">Welcome Back! Let's log you back in.</p>
            </div>
            ...
            <form onSubmit={handleSignIn} className="space-y-5">
              <div className="relative">
                <Input
                  ...
                  required
                  className="bg-white/30 text-white placeholder-white/70 border-white/50"
                />
         ...
         {error && <div className="text-red-400 text-sm">{error}</div>}
           ...
           <Button
            ...
            <div className="my-6">
              <div className="flex items-center justify-center text-white text-sm mb-4">
